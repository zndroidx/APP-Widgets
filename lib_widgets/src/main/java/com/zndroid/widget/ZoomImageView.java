...
public class ZoomImageView extends AppCompatImageView {
    ...
    private void init() {
        attacher = new ZoomViewAttach(this);
    ...
    /**
     * Get the current {@link ZoomViewAttach} for this view. Be wary of holding on to references
     * to this attacher, as it has a reference to this view, which, if a reference is held in the
     * wrong place, can cause memory leaks.
     *
     * @return the attacher.
     */
    public ZoomViewAttach getAttacher() {
        return attacher;
    }
